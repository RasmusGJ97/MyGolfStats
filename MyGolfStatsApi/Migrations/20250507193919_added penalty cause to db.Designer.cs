...
namespace MyGolfStatsApi.Migrations
{
    ...
    [Migration("20250507193919_added penalty cause to db")]
    partial class addedpenaltycausetodb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyGolfStatsApi.Db.Models.PenaltCause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyGolfStatsApi.Db.Models.PenaltCause", b =>
                {
                    b.HasOne("MyGolfStatsApi.Db.Models.Statistics", "Statistics")
                        .WithMany("PenaltyCause")
